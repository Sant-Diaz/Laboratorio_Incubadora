...
### 2.2 🌡️ Sistema de Calefacción y Control Térmico

| Parámetro | Descripción |
|-----------|-------------|
| **Elemento calefactor** | Resistencia eléctrica (heater) |
| **Mecanismo** | Convección forzada |
| **Rango de temperatura** | 36 °C – 37,5 °C |
| **Sensor asociado** | Termistor (NTC) |
...
> ⚠️ *Un mal funcionamiento en el sistema de calefacción puede producir hipotermia o hipertermia, ambas condiciones de alto riesgo para el neonato [4].*
...
### 2.5 🎛️ Módulo de Control y Panel de Alarmas
...
### 2.7 🛏️ Colchón y Estructura de Soporte (Chasis)
